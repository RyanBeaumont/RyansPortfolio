...
RSpec.describe "Students", type: :request do
  ...
  describe "GET /students" do
    context "when students exist" do
      let!(:student) { Student.create!(first_name: "Aaron", last_name: "Gordon", student_email: "gordon@msudenver.edu", major: "Computer Science BS", graduation_date: "2025-05-15") }
  ...
  describe "GET /students (search functionality)" do
    let!(:student1) { Student.create!(first_name: "Aaron", last_name: "Gordon", student_email: "gordon@msudenver.edu", major: "Computer Science BS", graduation_date: "2025-05-15") }
    let!(:student2) { Student.create!(first_name: "Jackie", last_name: "Joyner", student_email: "joyner@msudenver.edu", major: "Data Science and Machine Learning Major", graduation_date: "2026-05-15") }
    ...
    it "returns students graduating before the given date" do
      get students_path, params: { search: { graduation_date: "2026-01-01"}, graduation_options: "Graduate Before" }
      expect(response.body).to include("Aaron")
      expect(response.body).to_not include("Jackie")
    end
    ...
    it "returns students graduating before the given date" do
      gget students_path, params: { search: { graduation_date: "2026-01-01"}, graduation_options: "Graduate After" }
      expect(response.body).to_not include("Aaron")
  ...
  describe "POST /students" do
    context "with valid parameters" do
      ...
      it "creates a new student and redirects" do
        expect {
          post students_path, params: { student: { first_name: "Aaron", last_name: "Gordon", student_email: "gordon@msudenver.edu", major: "Computer Science BS", graduation_date: "2025-05-15" } }
      ...
      it "Returns 201 OK for successful student creation" do
        expect {
            post students_path, params: { student: { first_name: "Aaron", last_name: "Gordon", student_email: "gordon@msudenver.edu", major: "Computer Science BS", graduation_date: "2025-05-15" } }
    ...
    context "with invalid parameters" do
      ...
      it "Don't create a bad student" do
        expect {
            post students_path, params: { student: { first_name: "Aaron", last_name: "Gordon", student_email: "", major: "", graduation_date: "" } }
  ...
  describe "GET /students/:id" do
    context "when the student exists" do
      ...
      it "Successful response when showing student" do
        expect(response).to have_http_status(200)
      end

      # Test 11 (Student will complete this part)
      it "Student details are shown" do
        expect(response.body).to include("Aaron")
      end
    end
